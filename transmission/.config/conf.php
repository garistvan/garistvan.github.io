...
// Common system variables
	...
	define("_COPYRIGHTS",		"Transmission Admin Center v0.6 by QNAPAndy enhanced by Cristian and Spigot.<br>All rights reserved for its respective owners.<br>Transmission ver. 2.84");
	...
	$lb_size = "width=800, height=850";		// Slimbox dimensions -> outer (invisible) dimensions settings.json/addons.conf ->edit.php for inner dimensions -> dimensions of each item (line 116)
	$lb_size2 = "width=800, height=350";	// Slimbox dimensions -> outer (invisible) dimensions email notifier ->edit.php for inner dimensions -> dimensions of each item (line 116)
	...
	define("CMD_SED",                       "/bin/sed");

	
// Get QNAP server type, name and base location (ATTENTION: Do not change the cmds order below !!!)
	define("BASE",                          exec(CMD_GETCFG." Public path -f /etc/config/smb.conf | ".CMD_SED." 's/.\{6\}$//'"));
	...
	define("QNAP_WEB_PORT",			exec(CMD_GETCFG." QWEB Port -f /etc/config/uLinux.conf"));				// Default is 80
	...
	define("TRANSMISSION_UNPACK_LOG",		"logs/unpack.log");
	define("TRANSMISSION_UNPACK_LOG_NAME",	"unpack.log");
	define("TRANSMISSION_PERISCOPE_LOG",		"logs/periscope.log");
	define("TRANSMISSION_PERISCOPE_LOG_NAME",	"periscope.log");
        define("TRANSMISSION_DBDOWNLOADER_LOG",            "logs/dbdownloader.log");
        define("TRANSMISSION_DBDOWNLOADER_LOG_NAME",       "dbdownloader.log");
        define("TRANSMISSION_BLOCKLISTUPD_LOG",                 "logs/blocklistupdater.log");
        define("TRANSMISSION_BLOCKLISTUPD_LOG_NAME",            "blocklistupdater.log");
	
	$HOSTNAME = $_SERVER['SERVER_NAME'] ;
	
	define("CUR_TWX_STATUS",	exec(CMD_GETCFG." torrent_watch STATUS -f ".TRANSMISSION_ROOT."conf/addons.conf"));
	define("CUR_PER_STATUS",	exec(CMD_GETCFG." periscope STATUS -f ".TRANSMISSION_ROOT."conf/addons.conf"));
	define("CUR_UPK_STATUS",	exec(CMD_GETCFG." unzip_unrar STATUS -f ".TRANSMISSION_ROOT."conf/addons.conf"));
        define("CUR_AU_STATUS",        exec(CMD_GETCFG." auto_update STATUS -f ".TRANSMISSION_ROOT."conf/addons.conf"));
        define("CUR_DBD_STATUS",        exec(CMD_GETCFG." dropbox_downloader STATUS -f ".TRANSMISSION_ROOT."conf/addons.conf"));
        define("CUR_BLOCKLISTUPD_STATUS",        exec(CMD_GETCFG." blocklist_updater STATUS -f ".TRANSMISSION_ROOT."conf/addons.conf"));

	define("TRANSMISSION_RUNNING",		"<font size=2>Transmission: </font><font color=green size=2>Enabled</font>&nbsp;<a href='http://".$HOSTNAME.":9091' target='_blank'><img src='images/icon_new_window.gif' border='0' width='12' height='12' /></a>");
	define("TRANSMISSION_NOT_RUNNING",	"<font size=2>Transmission: </font><font color=red size=2>Disabled</font>");
	define("TORRENT_WATCH_ENABLED",		"<font size=2>TorrentWatch-X: </font><font color=green size=2>Enabled</font>&nbsp;<a href='http://".$HOSTNAME.":".QNAP_WEB_PORT."/torrentwatchx/web' target='_blank'><img src='images/icon_new_window.gif' border='0' width='12' height='12' /></a>");
	define("TORRENT_WATCH_DISABLED",	"<font size=2>TorrentWatch-X: </font><font color=red size=2>Disabled</font>");
	define("PERISCOPE_ENABLED",			"<font size=2>Periscope: </font><font color=green size=2>Enabled</font>");
	define("PERISCOPE_DISABLED",		"<font size=2>Periscope: </font><font color=red size=2>Disabled</font>");
	define("UNPACK_ENABLED",			"<font size=2>Unpack Function: </font><font color=green size=2>Enabled</font>");
	define("UNPACK_DISABLED",			"<font size=2>Unpack Function: </font><font color=red size=2>Disabled</font>");	
        define("AU_ENABLED",                     "<font size=2>Auto update: </font><font color=green size=2>Enabled</font>");
        define("AU_DISABLED",            "<font size=2>Auto update: </font><font color=red size=2>Disabled</font>");
        define("DBD_ENABLED",                        "<font size=2>Dropbox downloader: </font><font color=green size=2>Enabled</font>");
        define("DBD_DISABLED",                       "<font size=2>Dropbox downloader: </font><font color=red size=2>Disabled</font>");
        define("BLOCKLISTUPD_ENABLED",               "<font size=2>Blocklist updater: </font><font color=green size=2>Enabled</font>");
        define("BLOCKLISTUPD_DISABLED",              "<font size=2>Blocklist updater: </font><font color=red size=2>Disabled</font>");
